...
const App = () => {
  ...
  const showsomething = (event, index)  => {
    console.log("kkkk ", index * 1000);
    return (
      setTimeout( () => <Hisotry data={event} key={index} />, 1000 * index)
    )
  }
                  ...
                  <div className="col col-sm-12 col-md-6">
                    ...
                    <div className="event-wrap">
                      <ul className="event-list-group">
                        {history
                          ? history.map((event, index) => showsomething(event, index ) )
                          : null}
                      </ul>
                    </div>
                  </div>
